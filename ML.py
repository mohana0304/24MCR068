...
data.hist()
pyplot.savefig("histograms_rf.png")
pyplot.close()

# Step 4: Plot and save density plots silently
data.plot(kind='density', subplots=True, layout=(3,3), sharex=False)
pyplot.savefig("density_plots_rf.png")
pyplot.close()
...
model = RandomForestClassifier(random_state=seed)  # <-- Random Forest Classifier
...
joblib.dump(model, "random_forest_model.pkl")  # <-- Saved as random forest model
